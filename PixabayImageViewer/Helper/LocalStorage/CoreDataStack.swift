...
class CoreDataStack {
    ...
    static var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle(for: CoreDataStack.self).url(forResource: "Media", withExtension: "momd")! // type your database name here..
    ...
    static func loadData<T:NSFetchRequestResult>(entityName:String, predicate:NSPredicate?, sortDescriptor:NSSortDescriptor? = nil,  fetchLimit: Int? = nil) -> [T] {
